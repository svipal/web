...
from git.utils import (
    _AUTH, HEADERS, TOKEN_URL, build_auth_dict, get_issue_details, get_issue_comments, issue_number, org_name,
    repo_name,
)
    ...
    def github_issue_state(self):
        ...
        if not current_github_state:
            try:
                ...
                issue_details = get_issue_details(_org_name, _repo_name, int(_issue_num))
                if issue_details:
                    self.github_issue_details = issue_details
                    self.save()
