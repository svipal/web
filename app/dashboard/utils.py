...
def getStandardBountiesContractAddresss(network, contract_version=''):
...
def getBountyContract(network, contract_version=''):
    ...
    if contract_version == 'v1.1':
        ...
        v1_1_addr = getStandardBountiesContractAddresss(network, contract_version)
